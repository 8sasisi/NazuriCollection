...
if (!function_exists('frontend_ui_translation_map')) {
    function frontend_ui_translation_map()
    {
        return [
            ...
            'Nyuma' => 'Previous',
            'Mbele' => 'Next',
            "Karibu Nazuri Collections" => 'Welcome to Nazuri Collections',
            'Nenda Duka' => 'Go to Shop',
            "Ng'ara na Nazuri Collections" => 'Shine with Nazuri Collections',
            ...
            'Status:' => 'Status:',
            'Rangi' => 'Color',
            'Asante kwa kununua na Nazuri Collections. Tunathamini sana wateja wetu.' => 'Thank you for shopping with Nazuri Collections. We appreciate our customers.',
